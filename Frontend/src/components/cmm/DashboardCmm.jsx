...
const DashboardCmm = () => {
    const inputMenus = [
        { title: "Recruitment", path: "/cmm/recruitment-mm" },
        { title: "Input SDM Direkrut", path: "/cmm/input-sdm-mm" },
        { title: "Na Team", path: "/cmm/na-team-mm" },
        { title: "Target Triwulan", path: "/cmm/target-triwulan-mm" },
        { title: "Progress AFP", path: "/cmm/progress-afp-mm" },
    ];
                                            ...
                                            <Box sx={{ maxHeight: 180, overflow: "auto", mb: 1 }}>
                                                <Table size="small">
                                                    <TableHead>
                                                        <TableRow sx={{ backgroundColor: "#003366" }}>
                                                            <TableCell sx={{ color: "white" }}>No</TableCell>
                                                            <TableCell sx={{ color: "white" }}>Lamaran</TableCell>
                                                            <TableCell sx={{ color: "white" }}>Interview</TableCell>
                                                            <TableCell sx={{ color: "white" }}>Training</TableCell>
                                                        </TableRow>
                                                    </TableHead>
                                                    <TableBody>
                                            ...
                                            <Box sx={{ maxHeight: 180, overflow: "auto", mb: 1 }}>
                                                <Table size="small">
                                                    <TableHead>
                                                        <TableRow sx={{ backgroundColor: "#003366" }}>
                                                            <TableCell sx={{ color: "white" }}>No</TableCell>
                                                            <TableCell sx={{ color: "white" }}>Nama AFP</TableCell>
