...
const ProgressCmm = () => {
    ...
    const handleAdd = () => {
        ...
        const newEntry = {
            no: data.length + 1,
            mm: form.mm,
            jumlah_sdm_baru: form.jumlah_sdm_baru,
            mgm: form.mgm,
            ro: form.ro,
        };
            ...
            <div className="table-container">
                <form onSubmit={(e) => e.preventDefault()}>
                    <div className="form-grid">
                        ...
                        <div>
                            <label>Jumlah Sdm Baru</label>
                            <input
                                type="int"
                                name="jumlah_sdm_baru"
                                value={form.jumlah_sdm_baru}
                                onChange={handleChange}
                                placeholder="Jumlah SDM Baru"
                            />
                        </div>
